...
import static com.ryanli.rxdownloader.data.retrofit.download.DownloadUtils.formatSize;

/**
 * Auther: RyanLi
 * Data: 2018-06-18 19:09
 * Description: 表示下载状态, 如果isChunked为true, totalSize 可能不存在
 */
