...
import static com.ryanli.rxdownloader.data.retrofit.download.DownloadUtils.GMTToLong;
import static com.ryanli.rxdownloader.data.retrofit.download.DownloadUtils.closeQuietly;
import static com.ryanli.rxdownloader.data.retrofit.download.DownloadUtils.isChunked;
import static com.ryanli.rxdownloader.data.retrofit.download.DownloadUtils.longToGMT;
...
//                long end = recordBuffer.getLong(startIndex + 8);
    ...
    public DownloadRangeEntity readDownloadRange(File tempFile, int i) throws IOException {
        ...
        try {
            ...
            return new DownloadRangeEntity(startByte, endByte);
        } finally {
            closeQuietly(channel);
            closeQuietly(record);
        }
    ...
    private void prepareFile(File saveFile, long fileLength) throws IOException {
        ...
        try {
            ...
            if (fileLength != -1) {
                ...
                LogUtils.i("Aha, chunked download!");
                //Chunked 下载, 无需设置文件大小.
            }
        } finally {
            closeQuietly(file);
